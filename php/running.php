        ...
        <div class="container-fluid" style="justify-content: unset;">
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasNavbarLabel" style="color: #707070;">Running Records</h5>
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active-link" href="">
                                <div style="height: 40px;">
                                    <img id="runningIcon" src="../assets/icons/Running selected.svg" alt="Running icon" style="line-height: 40px;">
            ...
            <a class="my-brand navbar-brand" href="">Running Records</a>
